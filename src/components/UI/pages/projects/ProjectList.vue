    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="mb-2">
              ...
              <select class="form-select form-select mb-3" aria-label=".form-select-lg example" v-model="status">
            ...
            <div class="mb-2">
              ...
              <input type="date" class="form-control" id="start_date" v-model="start_date" aria-describedby="start_date"
                placeholder="Enter start date" />
            </div>
            <div class="mb-2">
              <label for="joining_date">End Date :</label>
              <input type="date" class="form-control" id="end_date" v-model="end_date" aria-describedby="end_date"
                placeholder="Enter end date" />
            </div>
            <div class="mb-2">
              <label for="employee_ids" class="form-label">Employees</label>
              <select class="form-select" multiple aria-label="multiple select" v-model="employee_ids">
        ...
        <div class="modal-footer">
          ...
          <button v-if="showAddProject" type="button" class="btn btn-success" @click="saveEmployee()">
            Add Project
          </button>
          <button v-if="showEditProject" type="button" class="btn btn-success" @click="saveChanges()">
            Update Project
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    addProject() {
      (this.modalTitle = "Add Project"), (this.showEditProject = false);
    ...
    saveEmployee() {
      try {
        ...
        axios
          .post(`http://127.0.0.1:8000/api/project`, adddRow, {
            headers: {
              Accept: 'application/json',
              Authorization: `Bearer ${token}`,
            }
    ...
    saveChanges() {
      try {
        ...
        axios
          .put(
            `http://127.0.0.1:8000/api/project/${this.currentRow.id}`,
            editedRow, {
              headers: {
                Accept: 'application/json',
                Authorization: `Bearer ${token}`,
